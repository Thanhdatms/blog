...
public class ReportService {
    ...
    public ReportResponse create(String blogId, ReportCreationRequest request, String userId){
    ...
    public List<ReportDetailResponse> getListReport(int page, int size, String userId) {
    ...
    public List<ReportDetailResponse> getListUserReport(String username, int page, int size, String userId){
    ...
    public ReportResponse updateReportStatus(String reportID, String reportStatus, String userId){
        ...
        if(report.getReportStatus() == EnumData.ReportStatus.APPROVE) {
